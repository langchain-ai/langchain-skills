---
name: langgraph-code
description: Learn to develop agents with LangGraph. Use this skill for understanding LangGraph primitives, multi-agent patterns, context management strategies (subagents, filesystem, compression), Commands, ToolMessages, and when to use abstractions like DeepAgents or create_agent.
---
...
**Need planning + filesystem + subagents?** → [DeepAgents](https://docs.langchain.com/oss/python/deepagents/overview)
```python
