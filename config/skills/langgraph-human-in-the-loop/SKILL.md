...
LangGraph supports a 4-tier error handling strategy. Match the error type to the right handler:
...
| User-fixable (missing info) | Human | `interrupt({"message": ...})` | Collect missing data |
